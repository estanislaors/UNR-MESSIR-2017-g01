...
The \msrcode{oeAddCoordinator} operation has the following properties:
	...
	\addnumbereddoublerow{}{AdtExperiencePoints: dtExperiencePoints}{used to initialized the experience points value} 
	...
	\addnumberedsinglerow{PreF}{ experience points must be a natural number}
