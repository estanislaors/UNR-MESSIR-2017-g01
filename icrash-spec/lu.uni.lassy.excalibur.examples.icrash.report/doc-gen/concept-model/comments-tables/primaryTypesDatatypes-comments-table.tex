...
\adddoublerow{dtExperiencePoints}{ integer that represent coordinator's experience to handle crisis }
...
\adddoublerow{dtPoliceHeadquarterID}{a unique identification information.}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid police headquarter identifiers.}
\adddoublerow{dtReport}{represent information about crisis}
\adddoubletwocolumnrow{attribute}{\msrcode{criticity: etCrisisCriticity}}{}
\adddoubletwocolumnrow{attribute}{\msrcode{position: dtGPSLocation}}{}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{}
\end{datadictionary}
...
\adddoublerow{etCrisisCriticity}{ crisis category assigned according its alerts received }
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{}
