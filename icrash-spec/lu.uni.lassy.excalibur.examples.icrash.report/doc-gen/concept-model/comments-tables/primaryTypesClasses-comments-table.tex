...
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtCoordinatorID, Alogin:dtLogin, Apwd:dtPassword, AExpPoints:dtExperiencePoints):ptBoolean}}{used to initialize the current object as a new instance of the ctCoordinator type.}
...
\adddoublerow{ctPoliceHeadquarter}{used to model system's representation about the police headquarters to take communication with them.}
\adddoubletwocolumnrow{attribute}{\msrcode{id: dtPoliceHeadquarterID}}{a unique identification information.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:dtPoliceHeadquarterID, Aname:dtString, Alocation:dtGPSLocation, AphoneNumber:dtPhoneNumber):ptBoolean}}{used to initialize the current object as a new instance of the ctPoliceHeadquarter type.}
